function [T,score] = unitary_kcopy_haar(ncopies,method,strategy)
 ...
 %%%%%%%%% 
    if method==3    
        ...
        while gap>precision
            ...
            [estimators,~] = estimator_optimization(p,T_temp,Ck,theta_i,ncopies);       % optimization over the estimators
