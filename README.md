...
To be run in MATLAB, [QETLAB](http://www.qetlab.com/), [YALMIP](https://yalmip.github.io) and [Mosek](https://docs.mosek.com/11.0/toolbox/index.html), as well as the [Parallel Computing Toolbox](https://www.mathworks.com/products/parallel-computing.html) are required. The following files are included in the repository:
...
- [unitary_and_noise_greedy.m](https://github.com/eriklandre/Bayesian-quantum-parameter-estimation/blob/main/SU(2)%20estimation/unitary_and_noise_greedy.m):
